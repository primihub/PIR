...
class StringEncoder {
   public:
    ...
    /**
     * Calculate the number of items that can be encoded into a single
     * plaintext.
   ...
   private:
    ...
    // Helper to calculate the number of coefficients needed to encode a number
    // of bytes of input in the current context, or InvalidArgumentError if the
    // input is too long.
