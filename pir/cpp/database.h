...
class PIRDatabase {
   public:
    /**
     * Creates and returns an empty PIR database with the params used to
     *generate a context.
    ...
    /**
     * Shortcut to create and return a new PIR database instance using a vector
     *of integers encoded one per database plaintext using IntegerEncoder. Only
    ...
    /**
     * Shortcut to create and return a new PIR database instance using the
     *values given. Values are packed into the database as per the parameters
     *given.
    ...
    /**
     * Populate the database plaintexts from a list of integers. Only really
     * used for testing.
     */
